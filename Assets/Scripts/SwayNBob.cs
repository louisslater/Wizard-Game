...
public class SwayNBob : MonoBehaviour
{
    ...
    void Start()
    {
        rb = playerController.GetComponentInChildren<Rigidbody>();
    }
    ...
    void BobOffset()
    {
        speedCurve += Time.deltaTime * (playerController.IsGrounded() ? rb.velocity.magnitude * bobExaggeration : 1f) + 0.01f;
